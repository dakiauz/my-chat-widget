...
const IconSearch: FC<IconCustomProps> = ({ className, fill = false, duotone = true }) => {
    return (
        <>
            {!fill ? (
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
                    <path
                        ...
                        strokeMiterlimit="10"
                    />
                    <path d="M10.5715 10.5715L14 14" stroke="currentColor" strokeMiterlimit="10" strokeLinecap="round" />
                </svg>
            ) : (
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
                    <path
                        ...
                        fill="currentColor"
                    />
                    <path d="M10.5715 10.5715L14 14" fill="currentColor" />
                </svg>
            )}
        </>
    );
